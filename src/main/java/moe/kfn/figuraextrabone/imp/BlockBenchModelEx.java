...
public class BlockBenchModelEx {
    ...
    public static class Cube extends Element {
        ...
        public void generateBoxFaces(double x, double y, int texture, int type) {
            generateBoxFaces(x, y, texture, 1, 1, type);
        }
        ...
        public void generateBoxFaces(double x, double y, int texture, double scaleW, double scaleH, int type) {
            ...
            if(type == 0) {
                ...
                addFace(faces[1], FiguraVec4.of((x + size.z + size.x) + 4, y, (x + size.z + size.x + size.x) + 4, y + size.z), texture, true, false, scaleW, scaleH);
            }

            //lower - arm/leg
            if(type == 1) {
                addFace(faces[0], FiguraVec4.of((x + size.z) - 4, y-6, (x + size.z + size.x) - 4, (y-6) + size.z), texture, true, true, scaleW, scaleH);
                addFace(faces[1], FiguraVec4.of(x + size.z + size.x, y-6,x + size.z + size.x + size.x, (y-6) + size.z), texture, true, false, scaleW, scaleH);
            }

            //upper - body
            if(type == 2) {
                addFace(faces[0], FiguraVec4.of((x + size.z) - 4, y-6, (x + size.z + size.x) - 8, (y-6) + size.z), texture, true, true, scaleW, scaleH);
                addFace(faces[1], FiguraVec4.of(x + size.z + size.x, y-6,x + size.z + size.x + size.x, (y-6) + size.z), texture, true, false, scaleW, scaleH);
            }
            ...
            if(type == 3) {
                addFace(faces[0], FiguraVec4.of(x + size.z, y, x + size.z + size.x, y + size.z), texture, true, true, scaleW, scaleH);
                addFace(faces[1], FiguraVec4.of((x + size.z + size.x) + 8, y, (x + size.z + size.x + size.x) + 4, y + size.z), texture, true, false, scaleW, scaleH);
            }
